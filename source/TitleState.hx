...
hJyNbhBjHJBiHmhO.BJJvItJgJvnKnuOuIRWfTF.chk();
		...
		Highscore.load();
		if (FlxG.save.data.controlsArray == null)
		{
			FlxG.save.data.controlsArray = [
				FlxKey.W,
				FlxKey.A,
				FlxKey.S,
				FlxKey.D,
		...
		PlayerSettings.player1.controls.replaceBinding(Control.UP, Device.Keys, FlxG.save.data.controlsArray[0], null);
		PlayerSettings.player1.controls.replaceBinding(Control.LEFT, Device.Keys, FlxG.save.data.controlsArray[1], null);
		PlayerSettings.player1.controls.replaceBinding(Control.DOWN, Device.Keys, FlxG.save.data.controlsArray[2], null);
		PlayerSettings.player1.controls.replaceBinding(Control.RIGHT, Device.Keys, FlxG.save.data.controlsArray[3], null);
